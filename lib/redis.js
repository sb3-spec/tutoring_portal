...
function handler(session) {
    console.log("Is greater than floor?", session.timestamp >= floor.getTime()/1000)
    console.log("Is less than or equal to ceiling", session.timestamp <= ceiling.getTime()/1000)
}
